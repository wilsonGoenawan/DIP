...
digitDatasetPath = 'C:\Wilson DIP\Pict impro\';
digitData = imageDatastore(digitDatasetPath, ...
        'IncludeSubfolders',true,'LabelSource','foldernames');
    
UnDatasetPath = 'C:\Wilson DIP\UnData';
UnData = imageDatastore(UnDatasetPath);
...
% training set has 6000 images and the test set has the remaining images
% from each label.
trainingNumFiles = 6000; %120, 6000
...
layers = [imageInputLayer([120 140 1])
