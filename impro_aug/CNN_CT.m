...
digitDatasetPath = 'C:\Wilson DIP\Pictures\';
...
% training set has 120 images and the test set has the remaining images
% from each label.
trainingNumFiles = 120; %120, 6000
